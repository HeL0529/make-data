...
def parse():
    ...
    parser.add_argument("-exp_name", default='example', type=str,
                        help='help id experiment, model save at model_dir/dataset_Kshot/exp_name')
    ...
    parser.add_argument('-total_test_instances', default=10000, type=int,
                        help='how many instances sampled when testing')

    parser.add_argument('-N', default=2, type=int, help='N way classificatoin')
    parser.add_argument('-K', default=1, type=int, help='K shot')

    parser.add_argument('-no_cuda', action='store_true')

    parser.add_argument("-embedding_dir", default='F:/Code/data', type=str,
                        help='directory storing pretrained embeddings')
